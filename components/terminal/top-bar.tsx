...
export function TopBar({ selectedTicker, onTickerChange }: TopBarProps) {
  ...
  return (
    <header className="h-14 bg-[#1e3a5f] border-b border-[#1e3a5f]/20 flex items-center px-6 gap-4">
      {/* AI Logo */}
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <Button className="h-8 px-4 bg-white text-[#1e3a5f] hover:bg-white/90">
          Live Help
        </Button>
      </div>
    </header>
