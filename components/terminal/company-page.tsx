...
> = {
  ...
  IOT: {
    ...
    changePercent: 3.00,
    lastClose: 41.60,
    range52w: { low: 18.50, high: 45.20 },
    marketCap: "$9.2B",
    avgVolume30d: "8.5M",
    description: "Samsara is a leading provider of IoT solutions for operations, offering a connected operations cloud that enables organizations to harness IoT data to develop actionable insights and improve their operations. The company's platform combines hardware, software, and cloud services to help businesses manage their fleets, assets, and sites more efficiently.",
  },
}

const getWorkflowAgents = (companyName: string) => [
  {
    id: "company-primer",
    icon: Building2,
    title: "Company Primer",
    description: `Conduct a deep dive on ${companyName}.`,
    time: "5-15 min",
  },
  {
    id: "top-questions",
    ...
    description: `Summarize common Q&A about ${companyName}.`,
    time: "3-12 min",
  },
  {
  ...
  },
  {
    ...
    description: `Evaluate ${companyName}'s standing relative to its key competitors.`,
    time: "5-15 min",
  },
]
...
export function CompanyPage({ ticker }: CompanyPageProps) {
  ...
  const workflowAgents = getWorkflowAgents(company.name)
    ...
    <div className="flex-1 overflow-auto bg-gray-100">
      <div className="max-w-[1400px] mx-auto p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="text-xs font-semibold text-black mb-2">LATEST</div>
            <div className="flex flex-wrap gap-2">
              {["10Q 05/28/2025", "10K 02/26/2025", "Earnings Transcript 05/28/2025", "Investor Presentation 06/25/2025", "Model Q1-2026"].map((tag) => (
                <button
                  key={tag}
                  className="px-3 py-1 bg-white hover:bg-gray-50 rounded text-xs text-gray-900 transition-colors border border-gray-300"
                >
                  {tag}
                </button>
              ))}
          ...
          <div>
            <div className="text-xs font-semibold text-black mb-2">INDUSTRY COMPS</div>
            <div className="flex flex-wrap gap-2">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-sm text-black mb-1">{agent.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-sm text-black">Expert Insights (442)</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-sm text-black">Broker Research (11,494)</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-sm text-black">Company Docs (1,847)</h3>
                <button className="text-xs text-blue-600 hover:underline flex items-center gap-1">
                  View <ChevronRight className="w-3 h-3" />
                </button>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-sm text-black">News & Regulatory (46,710)</h3>
                <button className="text-xs text-blue-600 hover:underline flex items-center gap-1">
                  View <ChevronRight className="w-3 h-3" />
                </button>
              </div>
